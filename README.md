...
- Fakturaunderlag with review of ready work orders, missing-data warnings, photo documentation, saved invoice text, draft/ready status, and mark-as-invoiced flow
